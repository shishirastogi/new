...
class Geometry3D:
    @staticmethod
    def cube(side):
        # Fixed: side**2 is squaring, side**3 is cubing
        return {
...
def run_lab_work():
    ...
    if choice == 1:
        ...
        # Fixed: dict key was 'Lateral Surface Area', not 'lsa'
...
# # Fixed: Double underscores are required for name and main
